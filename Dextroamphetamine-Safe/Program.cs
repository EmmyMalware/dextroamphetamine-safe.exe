...
int yMask);
   ...
   out IntPtr piSmallVersion, int amountIcons);
    ...
    private class payload11 : Payloads
    {
        ...
        Image r = Dextroamphetamine_Safe.Properties.Resources.theheck;
        public override void Draw(IntPtr hdc)
        {
            try
            {
    ...
    public static void Main()
    {
        ...
        if (MessageBox.Show("Run Safety?", "Dextroamphetamine-Safe", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) == DialogResult.Yes)
        {
            if (MessageBox.Show("Are you sure?", "Dextroamphetamine-Safe", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) == DialogResult.Yes)
            {
                bounceyform.Start();
                 //type.Start();
                //cur.Start();
